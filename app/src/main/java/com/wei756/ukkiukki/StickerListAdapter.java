...
public class StickerListAdapter extends RecyclerViewCustomAdapter {
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View view) {
            super(view);
            this.layout = (ConstraintLayout) view.findViewById(R.id.btn_layout_sticker);
     ...
     */
    public StickerListAdapter(StickerList stickerList, Activity act, int theme, RecyclerView mRecyclerView) {
    ...
    protected void setItemLayout() {
        ...
        layoutHeader[THEME_DEFAULT + SUBTHEME_DEFAULT] = R.layout.sticker_list; // dummy

        layoutItem[THEME_DEFAULT + SUBTHEME_DEFAULT] = R.layout.sticker_list;

        layoutFooter[THEME_DEFAULT + SUBTHEME_DEFAULT] = R.layout.sticker_list; // dummy
    }
    ...
    protected void bindItemViewHolder(@NonNull RecyclerView.ViewHolder viewholder, final int pos) {
        ...
        final Sticker sticker = (Sticker) mList.get(pos);
        String imgUrl = sticker.getOriginalUrl();
        if (imgUrl != null)
            Glide.with(context.getApplicationContext()).load(imgUrl).into(itemViewHolder.icon);

        // click event
        View.OnClickListener clickArticle = view -> stickerList.setStickerCode(sticker);
